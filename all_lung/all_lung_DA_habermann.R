...
# endothelial cells
endothelia <- subset(lung, subset = lineage_integrated == "Endothelia") # 40633 cells

# MPs
MP <- subset(lung, subset = lineage_integrated == "MP") # 58025 cells

# NK/T cells
NKTcell <- subset(lung, subset = lineage_integrated == "T cell" | lineage_integrated == "NK cell") # 16344 cells
Tcell <- subset(lung, subset = lineage_integrated == "T cell") # 12166 cells
NKcell <- subset(lung, subset = lineage_integrated == "NK cell") # 4178 cells

# mesenchymal cells
mesenchyme <- subset(lung, subset = lineage_integrated == "Mesenchyme") # 7977 cells
