...
marker.path <- "/home/s1987963/ds_group/Niklas/MP_liver/marker_genes/"
...
write.csv(MP.wilcoxon.marker, file = paste0(marker.path, "liver_MP_wilcoxon_marker.csv"))
...
write.csv(MP.MAST.marker, file = paste0(marker.path, "liver_MP_MAST_marker.csv"))