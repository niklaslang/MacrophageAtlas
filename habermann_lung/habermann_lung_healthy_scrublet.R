...
### load data ###
lung <- readRDS(paste0(habermann_lung.path, "habermann_lung_healthy.rds"))

### patient/sample identifiers ###
patient.ID <- c("THD0001", "THD0002", "THD0005", "VUHD65", "VUHD66",
                "VUHD67", "VUHD68", "VUHD69", "VUHD70", "VUHD071")
...
### merge samples ###
lung <- merge(lung.THD0001, c(lung.THD0002, lung.THD0005, lung.VUHD071,
                              lung.VUHD65, lung.VUHD66, lung.VUHD67, 
                              lung.VUHD68, lung.VUHD69, lung.VUHD70
))

### show results: 937 doublets detected ###
table(lung$scrublet_auto)

### save data ###
saveRDS(lung, "/Users/Niklas/Documents/MASTER/scrublet/habermann_lung/habermann_lung_healthy.rds")
