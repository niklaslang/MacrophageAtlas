...
### load data ###
kidney <- readRDS(paste0(wilson_kidney.path, "wilson_kidney_healthy.rds"))
...
### merge samples ###
kidney <- merge(kidney.GSM3823939_control, c(kidney.GSM3823940_control, kidney.GSM3823941_control))

### show results:  574 doublets detected ###
table(kidney$scrublet_auto)

### save data ###
saveRDS(kidney, "/Users/Niklas/Documents/MASTER/scrublet/wilson_kidney/wilson_kidney_healthy.rds")
