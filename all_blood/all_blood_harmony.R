...
### path variables ###
healthy.blood.path <- "/home/s1987963/ds_group/Niklas/healthy_organs/healthy_blood_raw_annotated.rds"
...
harmony.samples.path <- "/home/s1987963/ds_group/Niklas/all_blood/harmonize_samples/HVGs_conditions/2nd_go/"
