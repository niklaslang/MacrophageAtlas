...
### path variables ###
reyfman.lung.path <- "/home/s1987963/ds_group/Niklas/reyfman_lung/reyfman_lung_fibrotic.rds"
habermann.lung.path <- "/home/s1987963/ds_group/Niklas/habermann_lung/fibrotic/habermann_lung_fibrotic_filtered.rds"
lung.path <- "/home/s1987963/ds_group/Niklas/fibrotic_lung/"
harmony.samples.path <- "/home/s1987963/ds_group/Niklas/fibrotic_lung/harmonize_samples/HVGs_studies/"

### read files ###
reyfman.lung <- readRDS(reyfman.lung.path) # 29938 cells
habermann.lung <- readRDS(habermann.lung.path) # 116108 cells
...
### merge data ###
lung <- merge(reyfman.lung, habermann.lung) #total 146046 cells

### feature selection ###
# select the top 4000 HVGs of each study
...
lung.HVGs <- intersect(VariableFeatures(reyfman.lung), VariableFeatures(habermann.lung)) # 2751 HVGs
# set HVGs
...
lung.harmony <- lung %>% RunHarmony("patient.ID", theta = 2, reduction.save = "harmony_theta2", plot_convergence = TRUE) # harmonize 28 samples
...
### save data ###
saveRDS(lung.harmony, paste0(harmony.samples.path, "fibrotic_lung_harmony_samples.rds"))
...
dims <- c(30,40,46,50) # harmonize samples
for(d in dims){
  ...
  batch3.plot <- DimPlot(lung.harmony, reduction = "umap", group.by = "study", split.by = "patient.ID", pt.size = 0.01, ncol = 7)
  png(paste0(dim.path, "UMAP_dim", d, ".patient.batch2.png"), width=2100, height=1200, units="px")
  print(batch3.plot)
  dev.off()
  ...
  # no.5 - split by study
  batch5.plot <- DimPlot(lung.harmony, reduction = "umap", group.by = "study", split.by = "study", pt.size = 0.01, ncol = 2)
...
lung.harmony <- FindClusters(lung.harmony, reduction = "harmony_theta2", resolution = 1.2)
# run UMAP
...
cluster.annotation <- c("Fibrotic Lung Alveolar Macrophage 1", "Fibrotic Lung Alveolar Macrophage 2", "Fibrotic Lung ATII 1", 
                        "Fibrotic Lung Macrophage 1", "Fibrotic Lung Monocyte", "Fibrotic Lung Ciliated 1", 
                        "Fibrotic Lung T cell 1", "Fibrotic Lung Ciliated 2", "Fibrotic Lung cDC2", "Fibrotic Lung Macrophage 2",
                        "Fibrotic Lung ArtEndo", "Fibrotic Lung NK 1", "Fibrotic Lung Club Cell", 
                        "Fibrotic Lung Venous/Peribronchial Endo", "Fibrotic Lung Mesenchyme 2", "Fibrotic Lung Goblet 1", 
                        "RBC/immune cell doublet", "Fibrotic Lung Basal Cell", "Fibrotic Lung Plasma cell 1", 
                        "Fibrotic Lung Proliferating 1", "Fibrotic Lung ATI", "Fibrotic Lung Macrophage 3", 
                        "Fibrotic Lung Mesenchyme 1", "Fibrotic Lung ATII 5", "Fibrotic Lung B cell 1", "Fibrotic Lung Mast cell", 
                        "Fibrotic Lung Goblet 2", "Fibrotic Lung Cap Endo 2", "Fibrotic Lung NK 2", "Fibrotic Lung LymphEndo", 
                        "Fibrotic Lung Ciliated 3", "Fibrotic Lung CCR7+ cDC", "Fibrotic Lung Proliferating 2",
                        "Fibrotic Lung Mesothelia", "Fibrotic Lung pDC", "Fibrotic Lung Macrophage 4", "Fibrotic Lung Cap Endo 1",
                        "Fibrotic Lung B cell 2", "Fibrotic Lung Plasma cell 2", "Fibrotic Lung Proliferating 3", 
                        "Fibrotic Lung Ciliated 4", "Fibrotic Lung T cell 2", "Fibrotic Lung Mesenchyme 3", "Fibrotic Lung Mesenchyme 4"
)
...
lineage.annotation <- c("MP", "MP", "Epithelia", "MP", "MP", "Epithelia", "T cell", 
                        "Epithelia", "MP", "MP", "Endothelia", "NK cell", "Epithelia",
                        "Endothelia", "Mesenchyme", "Epithelia", "Doublet", "Epithelia",                       
                        "Plasma cell", "Proliferating", "Epithelia", "MP", "Mesenchyme", 
                        "Epithelia", "B cell", "Mast cell", "Epithelia", "Endothelia", 
                        "NK cell", "Endothelia", "Epithelia", "MP", "Proliferating", 
                        "Mesenchyme", "MP", "MP", "Endothelia", "B cell", "Plasma cell", 
                        "Proliferating", "Epithelia", "T cell", "Mesenchyme", "Mesenchyme"
)
...
### save data ###
saveRDS(lung.harmony, "/home/s1987963/ds_group/Niklas/fibrotic_organs/fibrotic_lung_annotated.rds")

### save R session ###
save.image(file = "/home/s1987963/ds_group/Niklas/fibrotic_lung/harmonize_samples/HVGs_studies/fibrotic_lung_harmony.RData")
